...
add_shortcode('image-compressor-v2', function () {
    ...
    wp_enqueue_script('Dropzone', 'https://unpkg.com/dropzone@5/dist/min/dropzone.min.js', array('jquery'));
    wp_enqueue_style('Dropzone', 'https://unpkg.com/dropzone@5/dist/min/dropzone.min.css');
    wp_enqueue_script('svelte-range-slider-pips', 'https://cdn.jsdelivr.net/npm/svelte-range-slider-pips@2.0.1/dist/svelte-range-slider-pips.js');
    wp_enqueue_script('juxtapose', 'https://cdn.knightlab.com/libs/juxtapose/latest/js/juxtapose.min.js', array('jquery'), NULL, true);
    wp_enqueue_script('serializejson', 'https://cdnjs.cloudflare.com/ajax/libs/jquery.serializeJSON/3.2.1/jquery.serializejson.min.js', array('jquery'));
    wp_enqueue_style('juxtapose', 'https://cdn.knightlab.com/libs/juxtapose/latest/css/juxtapose.css');
    ...
    return "
        <div class='image-compressor-v2'>
            <!-- PREVIEW START -->
            <div class='custom_wrapper_two preview display-none' id='previewTemplate'>
            ...
            <div class='custom_wrapper_two adjuster display-none'>
                <div id='container' class='img-comp-container'>
                    <div class='img-comp-img'>
                        <img class='image' src='https://localhost/wordpress/wp-content/plugins/image-compressor/giphy.gif'>
                    </div>
                    <div class='img-comp-img img-comp-overlay'>
                        <img class='image' src='https://localhost/wordpress/wp-content/plugins/image-compressor/giphy2.gif'>
                    </div>
                </div>
